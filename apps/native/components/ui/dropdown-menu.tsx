...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      className={cn(
        "z-50 overflow-hidden rounded-md border border-border mt-1 bg-popover p-1 shadow-md shadow-foreground/5 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        open
    ...
    <DropdownMenuPrimitive.Portal hostName={portalHost}>
      ...
      >
        <DropdownMenuPrimitive.Content
          className={cn(
            "z-50 overflow-hidden rounded-md border border-border bg-white p-1 shadow-md shadow-foreground/5 web:data-[side=bottom]:slide-in-from-top- web:data-[side=left]:slide-in-from-right-2 web:data-[side=right]:slide-in-from-left-2 web:data-[side=top]:slide-in-from-bottom-2",
            open
              ? "web:animate-in web:fade-in-0 web:zoom-in-95"
